...
CREATE TABLE `hotel` (
	...
	CONSTRAINT FK_hotel_station FOREIGN KEY (hot_sta_id) REFERENCES station(sta_id)
);
...
CREATE TABLE `chambre` (
	...
	CONSTRAINT PK_chambre PRIMARY KEY (cha_id),
	CONSTRAINT FK_chambre_hotel FOREIGN KEY (cha_hot_id) REFERENCES hotel(hot_id)
);
...
CREATE TABLE `reservation` (
	...
	FOREIGN KEY FK_reservation_chambre (res_cha_id) REFERENCES chambre(cha_id),
	FOREIGN KEY FK_reservation_client (res_cli_id) REFERENCES client(cli_id)
);
