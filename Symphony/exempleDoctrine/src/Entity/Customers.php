...
class Customers
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Orders::class, inversedBy="CustomersID")
     */
    ...
    public function getCustomersList(): ?Orders
    {
        return $this->CustomersList;
    }

    public function setCustomersList(?Orders $CustomersList): self
    {
