...
-- Si la base de donnée Vente existe elle est supprimée
CREATE DATABASE Vente;
-- Création de la base de donnée Vente
USE Vente;
-- Les commandes suivantes seront insérées dans la base 
...
-- Déclaration d'un index sur cli_nom 
